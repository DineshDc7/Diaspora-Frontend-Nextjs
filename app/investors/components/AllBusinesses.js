            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mt-4 gap-7">
                <div className="border border-blue-100 p-4 rounded-md bg-[#f5faff] shadow-sm">
                    ...
                    <div className="py-4 grid grid-cols-2">
                        <p className="mb-2 textColor text-sm">Sales : <span className="font-semibold text-base text-green-600">$55,433</span></p>
                        <p className="mb-2 textColor text-sm">Expenses : <span className="font-semibold text-base text-red-600">$355,433</span></p>
                        <p className="mb-2 textColor text-sm">Profit : <span className="font-semibold text-base text-orange-400">+ $111,433</span></p>
